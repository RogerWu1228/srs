...
class  Bbr2Sender final : public SendAlgorithmInterface {
 public:
 ...
 private:
  ...
  // QuicTime recent_event_time_;
  QuicTime start_bbr_timestamp_;
  QuicByteCount prior_infly_;
  static std::string ModeToString(Bbr2Mode mode) {
    switch (mode) {
