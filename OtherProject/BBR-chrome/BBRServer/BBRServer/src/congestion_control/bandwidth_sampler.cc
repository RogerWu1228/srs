...
static const int FLAGS_quic_max_tracked_packet_count = 1000;
...
QuicByteCount MaxAckHeightTracker::Update(QuicBandwidth bandwidth_estimate,
  ...
  QuicByteCount extra_bytes_acked = aggregation_epoch_bytes_ - expected_bytes_acked;
...
BandwidthSampler::BandwidthSampler(
    ...
    : total_bytes_sent_(0),
      ...
      max_tracked_packets_(FLAGS_quic_max_tracked_packet_count),
...
BandwidthSample BandwidthSampler::OnPacketAcknowledgedInner(
  ...
  // if(sample.rtt>QuicTime::Delta::FromMicroseconds(92233720368) ){
