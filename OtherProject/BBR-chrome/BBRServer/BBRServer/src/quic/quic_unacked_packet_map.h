...
#include "packet.h"
#include "quiche_circular_deque.h"
#include "quic_time.h"
#include "quic_transmission_info.h"
...
//   bool HasUnackedRetransmittableFrames() const;
  ...
  using const_iterator =
      QuicheCircularDeque<QuicTransmissionInfo>::const_iterator;
  using const_reverse_iterator =
      QuicheCircularDeque<QuicTransmissionInfo>::const_reverse_iterator;
  using iterator = QuicheCircularDeque<QuicTransmissionInfo>::iterator;
...
//       const QuicTransmissionInfo& info) const;
  ...
  // set to nullptr.
  QuicheCircularDeque<QuicTransmissionInfo> unacked_packets_;
